...
async function failedUpdateContractWithoutRequired(driver) {
    ...
    await allure.step("Clicando no botão de atualizar", async (ctx) => {
        try {
            ...
            if (textoMensagem === "Incluído com sucesso") {
                ...
                await assert.ok('Erro ao criar contrato com número inválido');
            }
...
export { failedUpdateContractWithoutRequired }; 