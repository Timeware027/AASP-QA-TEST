...
async function failedCreateContractWithFieldNumber(driver) {
    try {
        ...
        let inputs = ['Contrato de Teste Automatizado - teste', 'teste', 'numero com letra', '42', '01012025',
...
export { failedCreateContractWithFieldNumber };
