...
async function failedUpdateContractWithNumber(driver) {
        ...
        try {
            await allure.step("Alterando o título", async (ctx) => {
                try {
                    ...
                    await tituloInput.sendKeys(Key.TAB, Key.TAB);
                    await driver.sleep(2000);
                    await ctx.parameter("Status", "200");
            ...
            await allure.step("Alterando o número", async (ctx) => {
                try {
                    ...
                    await numeroInput.sendKeys('Teste Numero');
    ...
    await allure.step("Clicando no botão de atualizar", async (ctx) => {
        try {
            ...
            if (textoMensagem === "Alterado com sucesso") {
                ...
                await takeScreenshot(driver, "Contrato alterado com sucesso!");
            } else {
...
export { failedUpdateContractWithNumber }; 