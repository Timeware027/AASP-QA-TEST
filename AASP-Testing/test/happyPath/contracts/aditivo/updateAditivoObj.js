...
async function updateAditivoObject(driver) {
        ...
        try {
            await allure.step("Alterando o título", async (ctx) => {
                try {
                    ...
                    await tituloInput.sendKeys('Contrato de Teste Automatizado - Atualizado TESTE');
            ...
            await allure.step("Alterando o número", async (ctx) => {
                try {
                    ...
                    await driver.sleep(2000);
                    await driver.actions().sendKeys('Teste Update').perform();
